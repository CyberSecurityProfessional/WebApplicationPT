...
https://tryhackme.com/resources/blog/cyber-security-salary-career-options
...
https://tryhackme.com/resources/blog/the-teacher-becomes-the-student
https://tryhackme.com/resources/blog/brandons-success-story
```
...
If you are working as part of a law-enforcement department, you would be focused on collecting and analysing evidence to help solve crimes:
...
A penetration tester's job role is to test the security of the systems and software within a company.
this is achieved through attempts to uncover flaws and vulnerabilities through systemised hacking.
...
Learning Paths:
TryHackMe's learning paths will give you both the fundamental technical knowledge and hands-on experience,
which is crucial to becoming a successful Penetration Tester.
...
1. JR Penetration Tester - https://tryhackme.com/path/outline/jrpenetrationtester
2. Offensive Pentesting - https://tryhackme.com/path/outline/pentesting
3. Red Teamer - https://tryhackme.com/path/outline/redteaming
```
